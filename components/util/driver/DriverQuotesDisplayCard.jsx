...
const DriverQuotesDisplayCard = ({quote}) => {
/* eslint-disable react/prop-types */
  const getStatusColor = () => {
    ...
    return (
        <div style={{ border: '1px solid #ddd', padding: '10px', marginBottom:'8px'}} className="bg-blue-800 rounded-xl shadow shadow-lg text-white md:mx-auto md:w-1/2">
...
export default DriverQuotesDisplayCard;